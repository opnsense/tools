...
Install [FreeBSD](https://www.freebsd.org/) 15.1 RELEASE for amd64
on a machine with at least 50GB of hard disk and at least 16GB of RAM
to successfully build all standard images.  If you want to build ZFS
images on a ZFS installation please use a ZFS pool name other than
"zroot".  All tasks require a root user.  Do the following to grab the
repositories (overwriting standard ports and src):
